          ...
          {isPurchased ? (
            ...
            <button
              ...
              className={`w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition active:scale-[0.99] cursor-pointer ${
                hasEnoughDeposit
                  ? 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white shadow-lg shadow-indigo-950/40'
            ...
            >
              {isProcessing ? (
                <span className="flex items-center gap-2">
                  ...
                  Activating Universe with Deposit...
                </span>
              ) : hasEnoughDeposit ? (
                <>
