...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    whatsappBalance: 3500,
    pendingCashbackTotal: 2000,
    activeWhatsAppPackage: 'elite_1000',
    isAuthorizedPackagePurchased: false,
    isUnlockMpesaPurchased: false,
    isAutomationPackagePurchased: false,
    isVerifiedAgentPurchased: false,
  ...
  },
  {
    ...
    whatsappBalance: 0,
    pendingCashbackTotal: 0,
    activeWhatsAppPackage: undefined,
    isAuthorizedPackagePurchased: false,
    isUnlockMpesaPurchased: false,
    isAutomationPackagePurchased: false,
    isVerifiedAgentPurchased: false,
...
export const INITIAL_TASKS: EarningTask[] = [
  {
    id: 'task_01',
    title: 'Kenya FinTech Innovation Overview',
    category: 'video',
    description: 'Watch a 30-second video overview of mobile financial technology in Kenya to earn your reward.',
    reward: 120,
    durationSeconds: 30,
    iconName: 'PlaySquare',
    difficulty: 'Easy',
    videoUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=600&auto=format&fit=crop&q=80',
    isCompleted: false
  },
  {
    id: 'task_02',
...
export const INITIAL_TRANSACTIONS: Transaction[] = [
  {
    ...
    netAmount: 5000,
    status: 'completed',
    description: 'Lipa Na M-Pesa STK Recharge Deposit',
    createdAt: '2026-08-27T08:15:00Z',
    approvedBy: 'Auto-Disburse Engine'
  },
  {
    id: 'tx_102',
    mpesaReceiptNo: 'QK99WA2801',
    userId: 'usr_001',
    userName: 'Dennis Kiprono',
    userPhone: '0712345678',
    ...
    netAmount: 3500,
    status: 'completed',
    description: 'WhatsApp Status Broadcast (35 Views @ KES 100/view)',
    createdAt: '2026-08-27T06:30:00Z'
  },
  {
    id: 'tx_103',
    mpesaReceiptNo: 'QK98PK9911',
    userId: 'usr_001',
    userName: 'Dennis Kiprono',
    userPhone: '0712345678',
    ...
    netAmount: 1000,
    status: 'completed',
    description: 'Purchased Starter Package (30 Views @ KES 100/view)',
    createdAt: '2026-08-26T14:20:00Z'
  },
  {
    id: 'tx_104',
    mpesaReceiptNo: 'QK98CB8820',
    userId: 'usr_001',
    userName: 'Dennis Kiprono',
    userPhone: '0712345678',
    type: 'cashback_claim',
    ...
    netAmount: 2000,
    status: 'completed',
    description: 'Disbursed Cashback Bonus (Starter Package)',
  ...
  },
  {
    ...
    netAmount: 500,
    status: 'completed',
    description: 'Level 1 Referral Commission (Brian M. activation)',
  ...
  },
  {
    ...
    netAmount: 3455,
    status: 'completed',
    description: 'M-Pesa B2C Cashout Payout to 0712345678',
    createdAt: '2026-08-25T16:42:00Z',
    approvedBy: 'Auto-Disburse Engine'
  },
  {
    id: 'tx_107',
    mpesaReceiptNo: 'QK98IY1104',
    userId: 'usr_001',
    userName: 'Dennis Kiprono',
    userPhone: '0712345678',
    ...
    netAmount: 1500,
    status: 'completed',
    description: 'Harvested Yield from Bronze Starter 300% Plan',
  ...
  },
  {
    ...
    netAmount: 250,
    status: 'completed',
    description: 'Lucky Wheel Daily Spin Reward',
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  ...
  },
  {
    ...
    message: 'New high-paying video and partner tasks are now live in your dashboard. Complete them before midnight.',
    time: '8 hours ago',
    isRead: true,
    type: 'task'
  },
