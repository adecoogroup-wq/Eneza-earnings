...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr_mercy_cherotich',
    username: 'mercy_c',
    firstName: 'Mercy',
    lastName: 'Cherotich',
    phone: '0705610310',
    accountNumber: 'EE · 7056 · 1031',
    email: 'mcherotich917@gmail.com',
...
export const INITIAL_TRANSACTIONS: Transaction[] = [
  {
    id: 'tx_201',
    mpesaReceiptNo: 'QKDKW24KDZ',
    userId: 'usr_002',
    userName: 'Mary Wambui',
    userPhone: '0705610310',
    type: 'whatsapp_package',
    amount: 500,
    fee: 0,
    netAmount: 500,
    status: 'completed',
    description: 'Purchased Elite Starter Package (15 Views @ KES 100/view)',
    createdAt: '2026-08-27T11:44:00Z'
  },
  {
    id: 'tx_202',
    mpesaReceiptNo: 'QKJ1AUR53',
    userId: 'usr_002',
    userName: 'Mary Wambui',
    userPhone: '0705610310',
    type: 'deposit',
    ...
    netAmount: 500,
    status: 'completed',
    description: 'Lipa na M-Pesa Online Deposit (Recharge)',
    createdAt: '2026-08-26T22:24:00Z',
